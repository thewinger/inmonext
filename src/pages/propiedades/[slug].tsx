...
const Propiedad = ({ property }: Props) => {
  ...
  const featuresOpen = false
  // const [featuresOpen, setfeaturesOpen] = useState(false)

  return (
    <Layout>
      <div className='mb-24 mt-6 border-2 border-white/90 bg-white/90 p-4 text-slate-800 backdrop-blur-md'>
        <div className='sliderContainer flex items-center justify-center overflow-x-hidden'>
          <ProductSlider key={property.slug} slides={mediaItems as []} />
        </div>

        <div className='mt-4 flex flex-col gap-4 text-slate-900'>
          ...
          <div className='flex gap-4'>
            ...
            <div className='flex flex-col sm:flex-row sm:items-center sm:gap-2 sm:text-lg'>
              {propertyType && (
                <div className='-right capitalize text-slate-800'>
                  {propertyType}
          ...
          <div className='grid grid-flow-col place-items-center justify-around gap-4'>
            ...
            {propertyInfo?.housesize && (
              <div className='flex items-center gap-1 text-lg text-slate-800'>
                <span className='text-md font-medium text-slate-800'>
                  {propertyInfo.housesize}
                </span>
