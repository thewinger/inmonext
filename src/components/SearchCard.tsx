...
import { Location, Category } from "../generated/graphql";
import Select from "./Select";
import { ParsedUrlQuery } from "querystring";
import { initQueries, toFormattedArray, postQueries } from "../utils/main";
...
const SearchCard = ({ tipoViviendas, locations, query }: SearchCardProps) => {
  ...
  return (
    <div className="bg-white/75 p-4 shadow-md md:rounded-md">
      <Formik
